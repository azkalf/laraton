...
<html lang="en">
<head>
     <title>Skeleton - Landing Page Template</title>
     <meta charset="UTF-8">
     ...
     <link rel="stylesheet" href="{{ asset('template/hydro/css/bootstrap.min.css') }}">
     <link rel="stylesheet" href="{{ asset('template/hydro/css/magnific-popup.css') }}">
     <link rel="stylesheet" href="{{ asset('template/hydro/css/font-awesome.min.css') }}">

     <!-- MAIN CSS -->
     <link rel="stylesheet" href="{{ asset('template/hydro/css/templatemo-style.css') }}">
</head>
<body>
               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                         <div class="about-image">
                              <img src="{{ asset('template/hydro/images/about-image.jpg') }}" class="img-responsive" alt="">
                         </div>
                    </div>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <div class="media blog-thumb">
                              <div class="media-object media-left">
                                   <a href="blog-detail.html"><img src="{{ asset('template/hydro/images/blog-image1.jpg') }}" class="img-responsive" alt=""></a>
                              </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <div class="media blog-thumb">
                              <div class="media-object media-left">
                                   <a href="blog-detail.html"><img src="{{ asset('template/hydro/images/blog-image2.jpg') }}" class="img-responsive" alt=""></a>
                              </div>
                              <div class="media-body blog-info">
                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <div class="media blog-thumb">
                              <div class="media-object media-left">
                                   <a href="blog-detail.html"><img src="{{ asset('template/hydro/images/blog-image3.jpg') }}" class="img-responsive" alt=""></a>
                              </div>
                              <div class="media-body blog-info">
                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <div class="media blog-thumb">
                              <div class="media-object media-left">
                                   <a href="blog-detail.html"><img src="{{ asset('template/hydro/images/blog-image4.jpg') }}" class="img-responsive" alt=""></a>
                              </div>
                              <div class="media-body blog-info">
               ...
               <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                         ...
                         <div class="work-thumb">
                              <a href="{{ asset('template/hydro/images/work-image1.jpg') }}" class="image-popup">
                                   <img src="{{ asset('template/hydro/images/work-image1.jpg') }}" class="img-responsive" alt="Work">
                    ...
                    <div class="col-md-3 col-sm-6">
                         <!-- WORK THUMB -->
                         <div class="work-thumb">
                              <a href="{{ asset('template/hydro/images/work-image2.jpg') }}" class="image-popup">
                                   <img src="{{ asset('template/hydro/images/work-image2.jpg') }}" class="img-responsive" alt="Work">
                    ...
                    <div class="col-md-3 col-sm-6">
                         <!-- WORK THUMB -->
                         <div class="work-thumb">
                              <a href="{{ asset('template/hydro/images/work-image3.jpg') }}" class="image-popup">
                                   <img src="{{ asset('template/hydro/images/work-image3.jpg') }}" class="img-responsive" alt="Work">
                    ...
                    <div class="col-md-3 col-sm-6">
                         <!-- WORK THUMB -->
                         <div class="work-thumb">
                              <a href="{{ asset('template/hydro/images/work-image4.jpg') }}" class="image-popup">
                                   <img src="{{ asset('template/hydro/images/work-image4.jpg') }}" class="img-responsive" alt="Work">
	...
	-->
     ...
     <!-- SCRIPTS -->
     <script src="{{ asset('template/hydro/js/jquery.js') }}"></script>
     <script src="{{ asset('template/hydro/js/bootstrap.min.js') }}"></script>
     <script src="{{ asset('template/hydro/js/jquery.stellar.min.js') }}"></script>
     <script src="{{ asset('template/hydro/js/jquery.magnific-popup.min.js') }}"></script>
     <script src="{{ asset('template/hydro/js/smoothscroll.js') }}"></script>
     <script src="{{ asset('template/hydro/js/custom.js') }}"></script>
